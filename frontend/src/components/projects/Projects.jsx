...
export default function Projects() {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      const projectCards = projectsGrid.querySelectorAll("div > div");
      tl.fromTo(
        projectCards,
        {
          opacity: 0,
          ...
          {projects.map((project,index) => {
            ...
            return (
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-white/0 to-white/0 group-hover:from-white/5 group-hover:to-transparent transition-all duration-300 pointer-events-none"></div>

                {/* Content */}
                <div className="relative z-10 h-full flex flex-col justify-between">
                  <div>
                    <h3 className="text-2xl md:text-3xl font-semibold text-white/90 mb-2 group-hover:text-white transition-colors">
                      {project.title}
                    </h3>
                  ...
                  {/* GitHub + Live Links */}
                  <div className="mt-6 flex flex-wrap items-center gap-4 text-white/70 group-hover:text-white transition-all">
                    {/* GitHub Button */}
                    <a
                      href={project.github || "#"}
                      target="_blank"
